...
/**
 * <p>FileFragment are the root element of a Tree of VariableFragments, where
 * each VariableFragment represents one Variable within the (possibly not yet
 * existing) File F.</p>
 *
 * <p>The preferred way to create a FileFragment is by directly invoking its
 ...
 * </p>
 *
 * <p>FileFragments may be created and registered by calling
 ...
 *
 * <p>Alternatively, they can be created using the methods provided in
 * {@link FileFragmentFactory}</p>
 *
 * <p>Filenames can be local or global, since the IO-mechanism decides, whether
