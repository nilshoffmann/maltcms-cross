...
/**
 * A workflow result representing progress information. For example to update
 * information about a fragment command's progress. Also allows to model
 * hierarchical progress, with multiple steps.
 *
...
public interface IWorkflowProgressResult extends IWorkflowResult {
	 ...
	 *
	 * @return the names for each step
	 */
	 ...
	 *
	 * @return the current workflow progress result
	 */
